...
/**
 * Created by Claudio on 15/06/2016.
 */
public class MainActivityFragment extends Fragment {
    ...
    @Override
    public void onActivityResult(int requestCode1, int resultCode1, Intent data1) {
        super.onActivityResult(requestCode1, resultCode1, data1);
        callbackManager.onActivityResult(requestCode1, resultCode1, data1);
    }
}